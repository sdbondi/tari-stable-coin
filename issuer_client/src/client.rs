...
impl Client {
    ...
    pub fn authorize(client_id: String, client_secret: String) -> Result<Auth>
    ...
    pub async fn set_active_key(
        &mut self,
        index: u64,
    ) -> Result<KeysSetActiveResponse, WalletDaemonClientError> {
    ...
    pub async fn get_transaction<T: Borrow<TransactionGetRequest>>(
        ...
        self.send_request("transactions.get", request.borrow())
            .await
    }
    ...
    pub async fn get_transaction_result<T: Borrow<TransactionGetResultRequest>>(
        ...
        self.send_request("transactions.get_result", request.borrow())
            .await
    }
    ...
    pub async fn wait_transaction_result<T: Borrow<TransactionWaitResultRequest>>(
        ...
        self.send_request("transactions.wait_result", request.borrow())
            .await
    }
    ...
    pub async fn submit_transaction<T: Borrow<TransactionSubmitRequest>>(
        ...
        self.send_request("transactions.submit", request.borrow())
            .await
    }
    ...
    pub async fn get_account_balances<T: Borrow<AccountsGetBalancesRequest>>(
        ...
        self.send_request("accounts.get_balances", request.borrow())
            .await
    }
    ...
    pub async fn get_validator_fee_summary<T: Borrow<GetValidatorFeesRequest>>(
        ...
        self.send_request("validators.get_fee_summary", request.borrow())
            .await
    }
    ...
    pub async fn claim_validator_fees<T: Borrow<ClaimValidatorFeesRequest>>(
        ...
        self.send_request("validators.claim_fees", request.borrow())
            .await
    }
    ...
    pub async fn accounts_get_default(
        &mut self,
    ) -> Result<AccountGetResponse, WalletDaemonClientError> {
    ...
    pub async fn accounts_set_default(
        ...
        self.send_request(
            ...
            &AccountSetDefaultRequest { account },
        )
            .await
    }
    ...
    pub async fn accounts_confidential_transfer<T: Borrow<ConfidentialTransferRequest>>(
        ...
        self.send_request("accounts.confidential_transfer", req.borrow())
            .await
    }
    ...
    pub async fn accounts_reveal_funds<T: Borrow<RevealFundsRequest>>(
        ...
        self.send_request("accounts.reveal_funds", req.borrow())
            .await
    }
    ...
    pub async fn finalize_transfer_proof<T: Borrow<ProofsFinalizeRequest>>(
        ...
        self.send_request("confidential.finalize", req.borrow())
            .await
    }

    pub async fn create_confidential_output_proof<
        T: Borrow<ConfidentialCreateOutputProofRequest>,
    >(
        &mut self,
        req: T,
    ...
    pub async fn create_free_test_coins<T: Borrow<AccountsCreateFreeTestCoinsRequest>>(
        ...
        self.send_request("accounts.create_free_test_coins", req.borrow())
            .await
    }
    ...
    pub async fn mint_account_nft<T: Borrow<MintAccountNftRequest>>(
        ...
        self.send_request("nfts.mint_account_nft", req.borrow())
            .await
    }
    ...
    async fn jrpc_call<T: Serialize>(
        &mut self,
        method: &str,
        params: &T,
    ...
    async fn send_request<T: Serialize, R: DeserializeOwned>(
        ...
        let params =
            json::to_value(params).map_err(|e| WalletDaemonClientError::SerializeRequest {
                source: e,
